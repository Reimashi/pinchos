            ...
            <?php
                if (isset($params['premios-content'])) {
                    ...
                    foreach ($params['premios-content'] as $premio) {
                        $ganadorstr = (isset($premio['ganador'])) ? '<a href="' . SITE_URL . '/index.php/usuario/obtenerusuario/' . $premio['ganador'] . '" title="No implementado">' . $premio['ganador'] . '</a>' : 'Aún no se ha decidido un ganador';
